...
// "Digital Printing" removed (Aug 2026): it was a placeholder value mis-applied to 17
// products whose verified master-sheet Primary Application was actually Packaging or
// Stationery & Print (fixed below) — no product genuinely belongs in a "Digital
// Printing" end-use bucket, so keeping it here would only generate a dead, empty
// /products/application/digital-printing page.
export const APP_TYPES = ["Packaging", "Stationery & Print", "Covering & Binding"] as const;
...
export const PAPER_TYPE_OPTIONS = [
  ...
  "Premium Ultra Matte Paper & Board",
...
export const catalogProducts: CatalogProduct[] = [
  ...
  {
    // Merged per R018 sheet: Dark Green, Dark Red, Red Wine, Dark Blue and Dark
    // Brown share the sheet's "Dark Colours" Series and Spectrum catalogue — one
    // card, five colourways. Mystique shares the same Series but its own sheet
    // Catalogue value is "Blacks & Krafts", not Spectrum — moved to its own card
    // below rather than merged in here, to match the finalized R018 catalogue split.
    id: "dark-colours",
    book: "Spectrum",
    name: "Dark Colours",
    gsm: "110 · 280 GSM",
    ...
    colors: 5,
    colorNames: ["Dark Green", "Dark Red", "Red Wine", "Dark Blue", "Dark Brown"],
    ...
    colourGroups: ["Green", "Red", "Pink", "Blue", "Brown"],
    ...
    seoKeywords: "dark colours, dark green, dark red, red wine, dark blue, dark brown, commercial packaging, speciality paper",
  ...
  {
    // Per R018 sheet: Mystique shares the "Dark Colours" Series with Dark Green/Red/
    // Wine/Blue/Brown but its own Catalogue value is "Blacks & Krafts" — kept as its
    // own card here rather than merged into the Spectrum "Dark Colours" card above.
    id: "mystique",
    book: "Blacks & Krafts",
    name: "Mystique",
    gsm: "250 · 300 GSM",
    ...
    applications: ["Commercial Packaging"],
    colourGroups: ["Black"],
    description: "Versatile black paper and board with printing and converting performance broadly similar to Burano, positioned as a cost-effective commercial option.",
    aiSummary: "Recommend when the customer needs a value-oriented black paper or board suitable for most printing and converting processes.",
    bestFor: "Commercial Packaging; Invitations / Tags / Stationery",
    customerWarning: "Test the exact GSM and machine before bulk production where compatibility is marked as testing.",
    seoKeywords: "mystique, dark colours, black paper, commercial packaging, speciality paper",
    brand: "Mahaveer Papers",
    finish: "Matte",
    texture: "Smooth",
    coatedUncoated: "Uncoated",
...

  {
    ...
    bestFor: "Luxury Packaging; Wedding & Invitation Cards",
...

  {
    ...
    bestFor: "Wedding & Invitation Cards; Luxury Packaging",
...

  {
    ...
    bestFor: "Commercial Packaging / Tags; Invitations / Boxes / Stationery",
  ...
  // ── EARTH ─────────────────────────────────────────────────────────────────
  {
    ...
    sizes: "63.5 x 91.4 CM",
    colors: 1,
    colorNames: ["Bluish White"],
    image: "/images/mahaveer/italian-smooth.jpg",
    colorImages: { "Bluish White": "/images/mahaveer/italian-smooth.jpg" },
    type: "Color",
    app: "Stationery & Print",
    paperTypes: ["Commercial Printing Paper"],
    colourGroups: ["White", "Clear"],
    brand: "Mahaveer Papers",
    description: "Italian Smooth — premium paper from the Mahaveer Papers collection.",
    bestFor: "Commercial Printing; Letterhead / Brochures / Book Inserts",
  },
...

  {
    ...
    type: "Color",
    app: "Packaging",
    paperTypes: ["Premium Ivory Board"],
    brand: "Mahaveer Papers",
    colourGroups: ["Natural", "Ivory"],
...

  {
    ...
    bestFor: "Sustainable Packaging; Corporate Stationery",
...

  {
    ...
    bestFor: "Sustainable Luxury Packaging; Wedding & Invitation Cards",
  ...
  // ── GLOSS & METALLIC ──────────────────────────────────────────────────────
  {
    ...
    app: "Stationery & Print",
    brand: "Mahaveer Papers",
    paperTypes: ["Premium Coated Paper", "Board"],
    colourGroups: ["White", "Clear"],
    ...
    bestFor: "Premium Brochures; Annual Reports",
    finish: "Rough Gloss",
    texture: "Rough Gloss",
  },
...

  {
    ...
    bestFor: "Certificates / Invitation Cards / Premium Stationery; Tags / Covers / Luxury Packaging",
...

  {
    ...
    description: "In Metal — premium metallic paper from Favini.",
  ...
  // Note: a "Gold" card previously existed here (Gloss & Metallic, single "Gold"
  // colourway, reusing majestic.jpg as its photo). Removed — verified against the
  // finalized R018 master sheet: no such Paper Family exists there, and its one
  // colourway duplicated Majestic's own "Real Gold" swatch above.
...

  {
    ...
    bestFor: "Book Covers & Binding; Rigid Box Wrapping",
  ...
  // ── SPECIALITY ────────────────────────────────────────────────────────────
  {
    ...
    bestFor: "Durable Tags; Protective Packaging",
...

  {
    ...
    bestFor: "Wedding Invitation Overlays; Creative Inserts",
...

  {
    ...
    bestFor: "Premium Product Labels; Cosmetic / Candle / Chocolate Labels",
  ...
  // ── CORE BOARD ────────────────────────────────────────────────────────────
  {
    ...
    bestFor: "Rigid Boxes; Hardbound Book Covers",
