...
// book has one, for a more premium card image than a generic swatch. Blacks &
// Krafts, Speciality and Core Board have no Favini member, but every one of
// their own products already has a real product photo (e.g. inline-nero.jpg,
// tyvek.jpg, grey-binding-board.jpg) — those are picked up automatically by
// the fallback below, so no override is needed for them.
...
// Falls back to the first real product photo in that book when there's no override above.
